 ...
 * Generated at: 2020-11-16 00:41:52 UTC
...
public final class view_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("jbs.Jbs");
    _jspx_imports_classes.add("jbs.JbsDAO");
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	Jbs jbs = new JbsDAO().getJbs(jbsID);
      ...
      out.write("\t\t\t</button>\r\n");
      out.write("\t\t\t<a class=\"navbar-brand\" href=\"main.jsp\">JSP 웹 사이트</a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"collapse navbar-collapse\"\r\n");
      out.write("\t\t\tid=\"bs-example-navbar-collapse-1\">\r\n");
      out.write("\t\t\t<ul class=\"nav navbar-nav\">\r\n");
      out.write("\t\t\t\t<li><a href=\"main.jsp\">메인</a></li>\r\n");
      out.write("\t\t\t\t<li class=\"active\"><a href=\"jbs.jsp\">게시판</a></li>\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\t\t\t\t\t<ul class=\"dropdown-menu\">\r\n");
      out.write("\t\t\t\t\t\t<li><a href=\"logoutAction.jsp\">로그아웃</a>\r\n");
      out.write("\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\t\t\t");
      ...
      out.print( jbs.getJbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<","&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>작성자</td>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"2\">");
      out.print(jbs.getUserID());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>작성일자</td>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"2\">");
      out.print( jbs.getJbsDate().substring(0,11) + jbs.getJbsDate().substring(11,13)+ "시" + jbs.getJbsDate().substring(14,16)+"분" );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>내용</td>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"2\" style=\"min-height: 200px; text-align: left;\">");
      out.print( jbs.getJbsContent().replaceAll(" ", "&nbsp;").replaceAll("<","&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</tr>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\t<a href=\"jbs.jsp\" class=\"btn btn-primary\">목록</a>\r\n");
      out.write("\t\t\t");

				if (userID != null && userID.equals(jbs.getUserID())) {
			
      out.write("\r\n");
      out.write("\t\t\t\t<a href=\"update.jsp?jbsID=");
      out.print( jbsID);
      out.write("\" class=\"btn btn-primary\">수정</a>\r\n");
      out.write("\t\t\t \t<a href=\"deleteAction.jsp?jbsID=");
      out.print( jbsID);
